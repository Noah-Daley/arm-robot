...
var ASM_CONSTS = {
  89014: () => { if (document.fullscreenElement) return 1; },  
 89060: () => { return Module.canvas.width; },  
 89092: () => { return parseInt(Module.canvas.style.width); },  
 89140: () => { document.exitFullscreen(); },  
 89167: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89239: () => { if (document.fullscreenElement) return 1; },  
 89285: () => { return Module.canvas.width; },  
 89317: () => { return screen.width; },  
 89342: () => { document.exitFullscreen(); },  
 89369: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89563: () => { return window.innerWidth; },  
 89589: () => { return window.innerHeight; },  
 89616: () => { if (document.fullscreenElement) return 1; },  
 89662: () => { return Module.canvas.width; },  
 89694: () => { return parseInt(Module.canvas.style.width); },  
 89742: () => { if (document.fullscreenElement) return 1; },  
 89788: () => { return Module.canvas.width; },  
 89820: () => { return screen.width; },  
 89845: () => { return window.innerWidth; },  
 89871: () => { return window.innerHeight; },  
 89898: () => { if (document.fullscreenElement) return 1; },  
 89944: () => { return Module.canvas.width; },  
 89976: () => { return screen.width; },  
 90001: () => { document.exitFullscreen(); },  
 90028: () => { if (document.fullscreenElement) return 1; },  
 90074: () => { return Module.canvas.width; },  
 90106: () => { return parseInt(Module.canvas.style.width); },  
 90154: () => { document.exitFullscreen(); },  
 90181: ($0) => { Module.canvas.style.opacity = $0; },  
 90219: () => { return screen.width; },  
 90244: () => { return screen.height; },  
 90270: () => { return window.screenX; },  
 90297: () => { return window.screenY; },  
 90324: () => { return window.devicePixelRatio; },  
 90360: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90413: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90464: () => { Module.canvas.style.cursor = 'none'; },  
 90501: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90757: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90808: () => { if (document.pointerLockElement) return 1; },  
 90855: () => { if (document.fullscreenElement) return 1; },  
 90901: () => { return window.innerWidth; },  
 90927: () => { return window.innerHeight; }
};
