...
var ASM_CONSTS = {
  89110: () => { if (document.fullscreenElement) return 1; },  
 89156: () => { return Module.canvas.width; },  
 89188: () => { return parseInt(Module.canvas.style.width); },  
 89236: () => { document.exitFullscreen(); },  
 89263: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89335: () => { if (document.fullscreenElement) return 1; },  
 89381: () => { return Module.canvas.width; },  
 89413: () => { return screen.width; },  
 89438: () => { document.exitFullscreen(); },  
 89465: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89659: () => { return window.innerWidth; },  
 89685: () => { return window.innerHeight; },  
 89712: () => { if (document.fullscreenElement) return 1; },  
 89758: () => { return Module.canvas.width; },  
 89790: () => { return parseInt(Module.canvas.style.width); },  
 89838: () => { if (document.fullscreenElement) return 1; },  
 89884: () => { return Module.canvas.width; },  
 89916: () => { return screen.width; },  
 89941: () => { return window.innerWidth; },  
 89967: () => { return window.innerHeight; },  
 89994: () => { if (document.fullscreenElement) return 1; },  
 90040: () => { return Module.canvas.width; },  
 90072: () => { return screen.width; },  
 90097: () => { document.exitFullscreen(); },  
 90124: () => { if (document.fullscreenElement) return 1; },  
 90170: () => { return Module.canvas.width; },  
 90202: () => { return parseInt(Module.canvas.style.width); },  
 90250: () => { document.exitFullscreen(); },  
 90277: ($0) => { Module.canvas.style.opacity = $0; },  
 90315: () => { return screen.width; },  
 90340: () => { return screen.height; },  
 90366: () => { return window.screenX; },  
 90393: () => { return window.screenY; },  
 90420: () => { return window.devicePixelRatio; },  
 90456: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90509: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90560: () => { Module.canvas.style.cursor = 'none'; },  
 90597: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90853: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90904: () => { if (document.pointerLockElement) return 1; },  
 90951: () => { if (document.fullscreenElement) return 1; },  
 90997: () => { return window.innerWidth; },  
 91023: () => { return window.innerHeight; }
};
